...
<section class="checkout-orders">
   ...
   <h3>your orders</h3>
      ...
      ?>
         <p> <?= $fetch_cart['name']; ?> <span>(<?= '<span>&#8377</span>'.$fetch_cart['price'].'/- x '. $fetch_cart['quantity']; ?>)</span> </p>
      <?php
            }
         }else{
      ...
      ?>
         ...
         <div class="grand-total">grand total : <span><span>&#8377</span><?= $grand_total; ?>/-</span></div>
      </div>
